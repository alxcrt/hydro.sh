...
export const fancyButtonVariants = tv({
	slots: {
		root: [
			...
			"disabled:bg-(--bg-weak-50) disabled:bg-none disabled:shadow-none disabled:after:hidden disabled:before:hidden",
		],
...
export { FancyButtonIcon as Icon, FancyButtonRoot as Root };
